...
#define STRING_CONFIG_H_AUTHOR "(Will, Create Cafe)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ArdoB0T"
...
#define MAX_BED_POWER 210 // limits duty cycle to bed; 255=full current
  ...
  //Numbers Taken from Taz 1.0.0.1 marlin source
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100.5, 100.5, 1600, 416.5 }
